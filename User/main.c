...
const uint8_t test_text[]={"Hello, I2C read/write test"};
...
void MSE5611_Read(uint16_t dataAddr, uint8_t *pBuffer, uint16_t len)
{
  while (len--)
  {
    *pBuffer++ = APP_I2C_ReceiveByte(MSM9611_ADDRESS, dataAddr++);
    LL_mDelay(5);
  }
